...
class ExecuteActionResponse(_message.Message):
    __slots__ = ("outputs", "error", "diagnostics", "final_time")
    ...
    diagnostics: _containers.RepeatedCompositeFieldContainer[Diagnostic]
    final_time: float
    def __init__(self, outputs: _Optional[_Mapping[str, Value]] = ..., error: _Optional[str] = ..., diagnostics: _Optional[_Iterable[_Union[Diagnostic, _Mapping]]] = ..., final_time: _Optional[float] = ...) -> None: ...
...
class ExecuteStateResponse(_message.Message):
    __slots__ = ("states_visited", "final_context", "error", "diagnostics", "final_time")
    ...
    diagnostics: _containers.RepeatedCompositeFieldContainer[Diagnostic]
    final_time: float
    def __init__(self, states_visited: _Optional[_Iterable[str]] = ..., final_context: _Optional[_Mapping[str, Value]] = ..., error: _Optional[str] = ..., diagnostics: _Optional[_Iterable[_Union[Diagnostic, _Mapping]]] = ..., final_time: _Optional[float] = ...) -> None: ...
