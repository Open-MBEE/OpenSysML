...
func realPin(name, value string) seqPin { return seqPin{name: name, typ: realType, value: value} }
...
func TestFUMLFunctionsCompute(t *testing.T) {
	for _, c := range []struct {
		...
		{"RealFunctions-Neg", []seqPin{realPin("x", "2.5")}, realType, "-2.5", migrate.Mapped, ""},
		{"RealFunctions-Abs", []seqPin{realPin("x", "-2.5")}, realType, "2.5", migrate.Mapped, ""},
		{"RealFunctions-Inv", []seqPin{realPin("x", "4.0")}, realType, "0.25", migrate.Approximated, "v2 fails on an argument of 0.0"},
		{"RealFunctions-Floor", []seqPin{realPin("x", "-2.5")}, integerType, "-3", migrate.Mapped, ""},
		{"RealFunctions-Floor-Round", []seqPin{realPin("x", "2.5")}, integerType, "3", migrate.Mapped, "a half rounds to the larger integer, as in v1 (-2.5 to -2)"},
		{"RealFunctions-Floor-Round", []seqPin{realPin("x", "-2.5")}, integerType, "-2", migrate.Mapped, ""},
		{"RealFunctions-Floor-Round", []seqPin{realPin("x", "2.4")}, integerType, "2", migrate.Mapped, ""},
		{"RealFunctions-plus", []seqPin{realPin("x", "2.5"), realPin("y", "1.5")}, realType, "4.0", migrate.Mapped, ""},
		{"RealFunctions-minus", []seqPin{realPin("x", "2.5"), realPin("y", "1.5")}, realType, "1.0", migrate.Mapped, ""},
		{"RealFunctions-times", []seqPin{realPin("x", "2.5"), realPin("y", "2.0")}, realType, "5.0", migrate.Mapped, ""},
		{"RealFunctions-divide", []seqPin{realPin("x", "1.0"), realPin("y", "4.0")}, realType, "0.25", migrate.Approximated, "v2 fails on a divisor of 0.0"},
		{"RealFunctions-Max", []seqPin{realPin("x", "2.5"), realPin("y", "1.5")}, realType, "2.5", migrate.Mapped, ""},
		{"RealFunctions-Min", []seqPin{realPin("x", "2.5"), realPin("y", "1.5")}, realType, "1.5", migrate.Mapped, ""},
		{"RealFunctions-lt", []seqPin{realPin("x", "2.5"), realPin("y", "1.5")}, booleanType, "false", migrate.Mapped, ""},
		{"RealFunctions-gt", []seqPin{realPin("x", "2.5"), realPin("y", "1.5")}, booleanType, "true", migrate.Mapped, ""},
		{"RealFunctions-le", []seqPin{realPin("x", "2.5"), realPin("y", "2.5")}, booleanType, "true", migrate.Mapped, ""},
		{"RealFunctions-ge", []seqPin{realPin("x", "2.5"), realPin("y", "1.5")}, booleanType, "true", migrate.Mapped, ""},
		{"RealFunctions-ToString", []seqPin{realPin("x", "0.1")}, stringType, `"0.1"`, migrate.Approximated, "v1 leaves the text of a real unspecified beyond reading back as the same value"},
		{"RealFunctions-ToInteger", []seqPin{realPin("x", "-2.7")}, integerType, "-2", migrate.Mapped, ""},
		{"RealFunctions-ToInteger", []seqPin{realPin("x", "2.7")}, integerType, "2", migrate.Mapped, ""},
