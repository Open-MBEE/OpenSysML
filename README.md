...
| State machine runtime (Tier 5) | ✅ Complete (<!-- doc-counts:begin tier-state-machine -->210 conformance cases passing<!-- doc-counts:end tier-state-machine -->: transitions, accept events, sourceless) |
