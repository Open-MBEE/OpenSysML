...
| Behavioral parser (unified grammar with graceful fallback) | ✅ Complete (<!-- doc-counts:begin tier-behavioral-parser -->208 golden ASTs, 252 negative tests<!-- doc-counts:end tier-behavioral-parser -->) |
...
| Action execution engine (Tier 5) | ✅ Complete (<!-- doc-counts:begin tier-action-execution -->182 conformance cases passing<!-- doc-counts:end tier-action-execution -->) |
