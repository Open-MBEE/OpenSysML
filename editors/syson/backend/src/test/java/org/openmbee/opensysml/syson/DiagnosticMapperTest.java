...
class DiagnosticMapperTest {
    ...
    void mapsSpanAndNamedElement() {
        ...
        ElementIndex index = new ElementIndex(Map.of("Pkg::A",
                new ElementIndex.IndexedElement("Pkg::A", "id-Pkg::A", "sirius://a", element)));
        ...
        assertThat(mapped.diagnostic().qualifiedName()).isEqualTo("Pkg::A");
