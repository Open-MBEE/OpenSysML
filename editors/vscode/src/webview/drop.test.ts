...
const pump: RenderNode = { id: "n1", kind: "part def", name: "Pump", type: "", detail: "", fqn: "Rig::Pump", declaredHere: true, notation: "part def", owners: [rig] };
const valve: RenderNode = { id: "n2", kind: "part", name: "valve", type: "", detail: "", parent: "n1", fqn: "Rig::Pump::valve", declaredHere: true, notation: "part", owners: [{ fqn: "Rig::Pump", feature: false }, rig] };
const motor: RenderNode = { id: "n3", kind: "part def", name: "Motor", type: "", detail: "", fqn: "Rig::Motor", declaredHere: true, notation: "part def", owners: [rig] };
const fit: RenderNode = { id: "n4", kind: "requirement def", name: "Fit", type: "", detail: "", fqn: "Rig::Fit", declaredHere: true, notation: "requirement def", owners: [rig] };
const subject: RenderNode = { id: "n5", kind: "subject", name: "rig", type: "", detail: "", parent: "n4", fqn: "Rig::Fit::rig", declaredHere: true, notation: "subject", owners: [{ fqn: "Rig::Fit", feature: false }, rig] };
...
test("dropOn names an unnamed node by its kind", () => {
  const fork: RenderNode = { id: "n8", kind: "fork", name: "", type: "", detail: "", fqn: "Rig::Pump::fork1", declaredHere: true, notation: "fork", owners: [{ fqn: "Rig::Pump", feature: false }, rig] };
