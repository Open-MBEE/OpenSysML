...
func TestExploreRunsAMachineOnANestedObject(t *testing.T) {
	...
	wantReport(t, got, 0, "✓ explored Comms::Ground::listen: 2 outcomes",
		...
		"finalState quiet; visits idle, listening, quiet; this.isSolid = true; this.received = 2 | 2              | t=3.0: state machine modes of object #4 first of state machine listen of object #2, state machine modes of object #4; events at t=3.0: accept Frame first of time listening 1->quiet, accept Frame; at t=3.0: do listening first of do listening, dispatch time listening 1->quiet; at t=3.0: do listening first of do listening, dispatch time listening 1->quiet",
		"complete (5 runs)")
...
func TestExploreRunsSiblingsOnOneAssembly(t *testing.T) {
	...
	outcomes := []string{
		...
		"Comms::pair.craft.isSolid = true; Comms::pair.craft.sent = 4; Comms::pair.ground.isSolid = true; Comms::pair.ground.received = 2 | 2              | t=3.0: state machine modes of object #4 first of state machine listen of object #2, state machine modes of object #4",
		"complete (5 runs)",
	}
