...
func registerFlags(fs *flag.FlagSet) {
	...
	fs.StringVar(&fromFormat, "from", "", "Input format for -convert: sysml, kerml, ttl, turtle, rdf, or xmi/uml for a SysML v1 model to migrate (experimental; default: from the input's extension)")
