...
| [lord-demo/lord.sysml](lord-demo/lord.sysml) | [lord-demo/README.md](lord-demo/README.md) | *Legend of the Red Dragon*, the BBS door game, as a system: the town, the shops' stock, the masters, all twelve forest levels and the Red Dragon as parts; a warrior whose day is a state machine driven by the menu's signals, each place's deed — forest and dragon fights, healing, banking and its robbery, shopping, training, the three skill guilds, the inn's rooms, bribes, gems and sweethearts, the slaughter of other warriors, the fairies, the tavern and midnight — an executable action the transition performs, guarded so the warrior's constraints hold; fights whose dice are decisions the schedule resolves, checked over every schedule for the one that kills the warrior and replayed from its witness; `satisfy` of who may face the dragon, wed or slaughter; the solver on what a first day affords, why a Long Sword is out of reach, and the fewest hit points that win the brawl with and without power moves; the realm's lists and the warrior's standing in a generated document |
