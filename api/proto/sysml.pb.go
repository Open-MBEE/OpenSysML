...
const file_sysml_proto_rawDesc = "" +
	...
	"\x04unit\x18\x04 \x01(\tR\x04unit\"\xea\x06\n" +
	"\x05Value\x12\x1d\n" +
	...
	"\fmetaclass_id\x18\x02 \x01(\tR\vmetaclassId\"<\n" +
	"\bFunction\x12\x17\n" +
...
var file_sysml_proto_depIdxs = []int32{
	...
	58,  // 89: sysml.ValueSet.elements:type_name -> sysml.Value
	69,  // 90: sysml.TensorQuantity.components:type_name -> sysml.Quantity
