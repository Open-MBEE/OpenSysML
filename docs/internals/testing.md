...
- **Coverage:** 105/105 bundled library files — the 94 official SysML v2 standard library files and eleven non-normative OpenSysML extensions
...
- **Test:** `TestExecutionConformance` (internal/exec/runtime/)
- **Format:** `.sysml` + `.expected.json` pairs
- **Schema:** `internal/exec/runtime/testdata/conformance/README.md`
...
- **Test:** `TestExecutionTrace` (internal/exec/runtime/)
...
- **Test:** `TestRuntimeRobustness` (internal/exec/runtime/)
