...
- **Completeness:** SysML v2 textual notation support (99 of 99 standard library files parse cleanly: 94 vendored OMG files and 5 OpenSysML extensions)
...
- **Source of truth:** the 99 library files under `internal/core/libs/stdlib/`, embedded in
...
| Component | Status |
|-----------|--------|
| Lexer/Parser (structural + behavioral) | ✅ Operational (99/99 stdlib clean - see [conformance gate](../../internal/core/libs/stdlib_conformance_test.go)) |
...
**Parser coverage:** 99/99 bundled library files parse cleanly — the 94 official SysML v2 standard library files and five non-normative OpenSysML extensions: `OpenSysML Libraries/OpenSysMLMathFunctions.kerml`, `OpenSysML Libraries/DocumentQueries.sysml`, `OpenSysML Libraries/IdentityMetadata.sysml`, `OpenSysML Libraries/OOSEM.sysml` and `OpenSysML Libraries/MOSA.sysml`. Conformance verified by [stdlib_conformance_test.go](../../internal/core/libs/stdlib_conformance_test.go). Grammar reference available at [OMG Xtext grammar](https://github.com/Systems-Modeling/SysML-v2-Pilot-Implementation/tree/master/org.omg.kerml.xtext/src/org/omg/kerml/xtext).
...
- **Acceptance:** 99/99 files parse without errors
...
- **Corpus agreement:** 338 of 370 files agree diagnostic-by-diagnostic; 26 diagnostics are ours alone and 1040 the reference's alone, and the first number must be read by root: our diagnostics against the reference's own corpora fell while our non-standard-notation warnings on our own example models rose ([differential](../project/pilot-differential.md), `go run ./cmd/pilot-diff`).
