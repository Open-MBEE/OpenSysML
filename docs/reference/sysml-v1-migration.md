...
- A `uml:Diagram` a tool's `xmi:Extension` holds, with the diagram representation MagicDraw
  ...
  omits. A diagram whose list names elements is left as listed. Layout and the rest of the extension —
