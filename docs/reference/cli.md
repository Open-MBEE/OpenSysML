...
alternative with — and the check object carries `massLowerBound`, true when a bound was hit, a
schedule went unenumerated, a state was reached again or the persistent-set reduction left a move
