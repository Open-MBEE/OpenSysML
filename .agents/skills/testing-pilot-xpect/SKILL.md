...
after the runtime showcase round that is `375 file(s), 338 fully agreeing; 34 agreed diagnostic(s), 38
only ours, 1118 only the pilot's`. Read the number out of
