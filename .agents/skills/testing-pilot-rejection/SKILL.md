...
`cmd/pilot-reject/testdata/negative/` (305 hand-written invalid models, one violated rule + citation
...
conjugated typing and end-feature rules, the end-multiplicity, return-owner and single-conjugator rules, the keyword-first relationship end kinds, the prefix and body-context cases, and the redefinition name-resolution cases), with a fresh library cache:
