...
the headline the committed baseline holds — `370 file(s), 338 fully agreeing; 34 agreed
diagnostic(s), 26 only ours, 600 only the pilot's` after the expressions example joined `examples/`, so read it from
