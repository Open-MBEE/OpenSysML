...
the headline the committed baseline holds — `378 file(s), 346 fully agreeing; 38 agreed
diagnostic(s), 38 only ours, 1334 only the pilot's` after the Legend of the Red Dragon completed-mechanics round at the `2026-08` pin, so read it from
