...
the headline the committed baseline holds — `369 file(s), 337 fully agreeing; 34 agreed
diagnostic(s), 23 only ours, 600 only the pilot's` after the collection-body element typing round, so read it from
