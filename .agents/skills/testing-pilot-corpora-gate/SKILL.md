...
the headline the committed baseline holds — `370 file(s), 343 fully agreeing; 34 agreed
diagnostic(s), 32 only ours, 665 only the pilot's` at the `2026-08` re-pin, so read it from
