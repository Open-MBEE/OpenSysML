...
the headline the committed baseline holds — `377 file(s), 346 fully agreeing; 38 agreed
diagnostic(s), 38 only ours, 1185 only the pilot's` after the verdict-table example round at the `2026-08` pin, so read it from
