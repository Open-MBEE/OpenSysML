...
- Measured at the `2026-08` pin, with a fresh library cache: `379 file(s), 347 fully agreeing; 38 agreed,
  38 only ours, 1333 only the pilot's`, JSON totals `openSysMLDiagnostics 79 / pilotDiagnostics
  1374 / severityMismatch 3`; ~2 min wall, byte-identical across runs *and* after a from-scratch
...
current: a live run gives `379 file(s), 347 fully agreeing; 38 agreed, 38 only ours, 1333 only the
