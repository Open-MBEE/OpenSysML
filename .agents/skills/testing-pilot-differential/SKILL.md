...
- Measured after the Spacecraft downlink example round at the `2026-08` pin, with a fresh library cache: `379 file(s), 347 fully agreeing; 38 agreed,
...
current: a live run gives `379 file(s), 347 fully agreeing; 38 agreed, 38 only ours, 1247 only the
