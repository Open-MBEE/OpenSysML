...
- Measured after the verdict-table example round at the `2026-08` pin, with a fresh library cache: `377 file(s), 346 fully agreeing; 38 agreed,
...
but only while the baseline is current. Check that first. As of the rebaseline that came with the verdict-table example round it **is**
current: a live run gives `377 file(s), 346 fully agreeing; 38 agreed, 38 only ours, 1185 only the
