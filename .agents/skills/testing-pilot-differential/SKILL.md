...
- Measured after the MOSA library round, with a fresh library cache: `371 file(s), 337 fully agreeing; 34 agreed,
  33 only ours, 1111 only the pilot's`, JSON totals `openSysMLDiagnostics 70 / pilotDiagnostics
...
current: a live run gives `371 file(s), 337 fully agreeing; 34 agreed, 33 only ours, 1111 only the
