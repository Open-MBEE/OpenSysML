...
- Measured after the expressions example joined `examples/`, with a fresh library cache: `368 file(s), 337 fully agreeing; 34 agreed,
...
current: a live run gives `368 file(s), 337 fully agreeing; 34 agreed, 21 only ours, 600 only the
