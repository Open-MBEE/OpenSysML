...
- Measured after the collection-body element typing round, with a fresh library cache: `369 file(s), 337 fully agreeing; 34 agreed,
  23 only ours, 600 only the pilot's`, JSON totals `openSysMLDiagnostics 59 / pilotDiagnostics
...
but only while the baseline is current. Check that first. As of the rebaseline that came with the collection-body element typing round it **is**
current: a live run gives `369 file(s), 337 fully agreeing; 34 agreed, 23 only ours, 600 only the
