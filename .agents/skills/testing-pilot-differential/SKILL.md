...
- Measured after the Legend of the Red Dragon completed-mechanics round at the `2026-08` pin, with a fresh library cache: `378 file(s), 346 fully agreeing; 38 agreed,
...
current: a live run gives `378 file(s), 346 fully agreeing; 38 agreed, 38 only ours, 1334 only the
