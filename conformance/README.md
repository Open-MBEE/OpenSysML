...
| `undetermined_value` | Response-population capability: encode undetermined results (a model-level read the model leaves open) as unsupported nulls; no request asks for them. |
