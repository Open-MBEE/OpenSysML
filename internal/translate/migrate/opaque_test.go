...
func TestTranslateExpr(t *testing.T) {
	cases := []struct {
		...
		{"JavaScript", "Math.max(t)", "", "this.t", "Real"},
		{"JavaScript", "Math.min(i + 1) * 2", "", "(this.i + 1) * 2", "Integer"},
		...
		{"Javascript Rhino", "t / 2", "", "this.t / 2", "Real"},
		{"JavaScript (Nashorn)", "t / 2", "", "this.t / 2", "Real"},
		{"ECMAScript 2015", "t / 2", "", "this.t / 2", "Real"},
		{"js", "t / 2", "", "this.t / 2", "Real"},
		{"Rhino 1.7", "t / 2", "", "this.t / 2", "Real"},
		{"JavaScript 1.8 Rhino", "t / 2", "", "this.t / 2", "Real"},
...
func TestTranslateRefusals(t *testing.T) {
	cases := []struct {
		...
		{"JavaScript", "Math.max(name)", false, refusedType, "Math.max"},
		{"JavaScript", "Math.min(tanks)", false, refusedType, "Math.min"},
		...
		{"English", "Math.sqrt(t) > 3", false, refusedConstruct, "Math.sqrt("},
		{"English", "java.util.Collections.max(xs) > 3", false, refusedConstruct, "java.util.Collections.max("},
		{"English", "name.equals(name)", false, refusedConstruct, "name.equals("},
		{"English", "Ready(GS_Found)", false, refusedConstruct, "Ready("},
		{"JavaScript Expression Language", "i / 2", false, refusedLanguage, "JavaScript Expression Language"},
		{"ECMAScript for XML", "i / 2", false, refusedLanguage, "ECMAScript for XML"},
		{"JavaScript 1.8 SE", "i / 2", false, refusedLanguage, "JavaScript 1.8 SE"},
		{"Rhino Shell", "i / 2", false, refusedLanguage, "Rhino Shell"},
		{"JSON", "i / 2", false, refusedLanguage, "JSON"},
		{"JavaScript 1.8 1.7", "i / 2", false, refusedLanguage, "JavaScript 1.8 1.7"},
