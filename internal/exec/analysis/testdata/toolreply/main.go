...
// second argument and chatter on standard output, lines and lines-regex write text lines,
// exit3 and exit1 exit with a status, and sleep never answers. It is built by the tests
// that run it and lives under testdata, out of every build.
package main
