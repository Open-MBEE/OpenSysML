...
func (a *activity) produces(n *xmi.Element) bool {
...
func (a *activity) producesAt(pin *xmi.Element) bool {
	n := pin.Parent
...
func (a *activity) calleeOutput(pin *xmi.Element) (callee, param *xmi.Element) {
	n := pin.Parent
	switch n.Type {
	case "CallBehaviorAction":
...
func (m *migration) dryOutputs(b *xmi.Element) map[*xmi.Element]bool {
...
func (a *activity) dryParameter(p *xmi.Element) bool {
...
func (a *activity) dryFlow(e *xmi.Element) bool {
...
func (a *activity) valueless(pin *xmi.Element) *xmi.Element {
...
func (a *activity) unarguedParameter(args []*xmi.Element, callee *xmi.Element) (*xmi.Element, string) {
	i := 0
	for _, p := range callee.Owned("ownedParameter") {
...
func requiresValue(p *xmi.Element) bool {
...
func (a *activity) dryArgument(pin, callee, p, dry *xmi.Element) string {
...
func (a *activity) uncontexted(callee *xmi.Element, why string) string {
